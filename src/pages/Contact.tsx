      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="md:w-1/2">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              <Mail className="text-orange-600 mr-2" size={20} />
              <span>marie.kone@coiffure-elegance.com</span>
            </div>
            <div className="flex items-center">
              <MapPin className="text-orange-600 mr-2" size={20} />
              <span>123 Rue du Commerce, Cocody, Abidjan</span>
            </div>
            <div className="flex items-center">
              <Clock className="text-orange-600 mr-2" size={20} />
              <span>Lun-Sam: 9h-19h, Dim: Sur rendez-vous</span>
            </div>
          </div>
          <div className="mt-8">
        ...
        <div className="md:w-1/2">
          ...
          <form>
            ...
            <div className="mb-4">
              ...
              <textarea id="message" name="message" rows={4} className="w-full p-2 border border-gray-300 rounded-md" required></textarea>
            </div>
            <button type="submit" className="bg-orange-600 text-white py-2 px-4 rounded-md hover:bg-orange-700 transition duration-300">Envoyer</button>
          </form>
        </div>
      </div>
    </div>
